...
def evaluate_model(model_name, clf_model, X_test_matrix, Y_test_matrix, columns, title):
    ...
    # estimator = initialize_model(model_name, 0.3)
    # TODO
    # plot_learning_curve(estimator, title, X_train_matrix, Y_train_matrix, ylim=(0.3, 1.01), cv=cv, n_jobs=4)
    plt.show()
...
def impute_missing_data(data_matrix):
    ...
    return imp.fit_transform(data_matrix)
